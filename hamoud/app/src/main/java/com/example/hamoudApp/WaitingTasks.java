...
public class WaitingTasks extends AppCompatActivity implements TaskAdapter.OnTaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_waiting_tasks);
    ...
    private void getdata() {
        ...
        myLists.add(new myTaskModelList(R.drawable.profile,"khedmet sba7e","2021-09.09","10:00"));
        myLists.add(new myTaskModelList(R.drawable.profile,"khedmet sba7e","2021-09.09","10:00"));
        adapter=new TaskAdapter(myLists,this, (TaskAdapter.OnTaskListener) this);
    ...
    public void onTaskClick(int position) {
        ...
        if (!tasksWithInfo.isEmpty()){
            Intent intent = new Intent(WaitingTasks.this, TaskDetails.class);
    ...
    private void tasksBuilder() {
        ...
        String url = Config.WAITING_TASKS_DATA_URL + "2021-09-13";//today.trim();
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(WaitingTasks.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
