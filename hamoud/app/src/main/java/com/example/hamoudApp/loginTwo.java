...
public class loginTwo extends AppCompatActivity {
    ...
    TextView login;
    String URL = "https://hamoudserver.000webhostapp.com/API/logindist.php";//LOGIN_URL;
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.equals("success")) {
                                ...
                                Toast.makeText(loginTwo.this, "Invalid Login Id/Password", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }, new Response.ErrorListener() {
                        @Override
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(loginTwo.this, error.toString().trim(), Toast.LENGTH_SHORT).show();
                        }
                    }) {
                        @Override
