...
public class doneTasks extends AppCompatActivity implements TaskAdapter.OnTaskListener{
    ...
    public void onTaskClick(int position) {
        ...
        if (!tasksWithInfo.isEmpty()){
            Intent intent = new Intent(doneTasks.this, TaskDetails.class);
    ...
    private void tasksBuilder() {
        ...
        String url = Config.DONE_TASKS_DATA_URL + "2021-09-13";//today.trim();
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(doneTasks.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
                    }
                });
